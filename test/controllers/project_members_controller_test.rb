...
class ProjectMembersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create project_member" do
    assert_difference('ProjectMember.count') do
      post project_members_url, params: { project_member: { person_id: @project_member.person_id, project_id: @project_member.project_id } }
    end
  ...
  test "should update project_member" do
    patch project_member_url(@project_member), params: { project_member: { person_id: @project_member.person_id, project_id: @project_member.project_id } }
